...
<head>
  ...
  function showhidefield()
	  {
		if (document.frm.billing_shipping.checked)
		{
...
<body>
  ...
  <form action="charge.php" method="POST" id="payment-form" name="frm">
...
<!-- Customer Info -->
	...
	<div class="form-row">
	  <label>
        ...
        <input type="text" size="20" name="customer_fname" />
      </label>
	
	  <label>
        <span>Last Name</span>
        <input type="text" size="20" name="customer_lname" />
      </label>
	</div>
...
<!-- Shipping Info -->
    ...
    <div class="form-row">
	  <label>
        ...
        <input type="checkbox" name="billing_shipping" id="billing_shipping"  onclick="showhidefield()" value="same">
      </label>
	</div>
